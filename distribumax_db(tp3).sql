-- =====================================================================
-- distribumax_db.sql
-- Sistema de Gestion de Inventario y Logistica - DistribuMax S.A.
-- Script de creacion de base, tablas, datos de prueba y consultas.
-- Continuidad del modelo de datos definido en el TP2.
-- =====================================================================
...
INSERT INTO stock (id_producto, cantidad, stock_minimo) VALUES
    (1, 85, 20), (2, 12, 20), (3, 40, 15),
    (4, 8, 25), (5, 60, 25), (6, 30, 10);
...
INSERT INTO usuarios (usuario, password_hash, nombre, rol) VALUES
    ('admin', 'hc63bc483', 'Administrador General', 'ADMIN'),
    ('vendedor1','h14b5136d', 'Juan Perez', 'VENDEDOR'),
    ('chofer1', 'h2ccc37b6', 'Carlos Ruiz', 'TRANSPORTISTA');
...
-- a) Productos con stock por debajo del minimo (sustenta RF03):
...
-- b) Detalle completo de un pedido con cliente y subtotales:
SELECT c.nombre AS cliente, p.id_pedido, pr.nombre AS producto,
...
-- c) Reporte de ventas por categoria en un periodo (sustenta RF08):
